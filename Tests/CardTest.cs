...
//         {
//             Card card1 = new Card("Squirrel", "Content/img/squirrel.jpg", "A vicious, agile squirrel.", 1, 1, 0, 1);
//             Card card2 = new Card("Squirrel", "Content/img/squirrel.jpg", "A vicious, agile squirrel.", 1, 1, 0, 1);
//
...
//         // {
//         //     Card testCard = new Card("Squirrel", "Content/img/squirrel.jpg", "A vicious, agile squirrel.", 1, 1, 0, 1);
//         //     testCard.Save();
//         //
